...
import com.utility.utility_billing_system.enums.OtpDeliveryMode;
...
public class OtpProperties {
    ...
    /** EMAIL uses SMTP; CONSOLE logs and returns the OTP in the API response (no Gmail needed). */
    private OtpDeliveryMode deliveryMode = OtpDeliveryMode.EMAIL;

    public boolean isConsoleDelivery() {
        return deliveryMode == OtpDeliveryMode.CONSOLE;
    }
}
