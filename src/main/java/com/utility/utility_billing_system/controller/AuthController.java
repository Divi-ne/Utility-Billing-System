...
public class AuthController {
    ...
    /** Resends a confirmation OTP for an unverified account (customer signup or admin-created user). */
    ...
    /** Confirms an account with the OTP from email. */
    ...
    /** Sets the initial password after OTP verification (admin-created accounts). */
    @PostMapping("/password/set")
    @Operation(summary = "Set password after email verification")
    public ResponseEntity<ApiResponse<OtpResponse>> setPassword(@Valid @RequestBody SetPasswordRequest request) {
        OtpResponse response = authService.setPassword(request);
        return ResponseEntity.ok(ApiResponse.<OtpResponse>builder()
                .success(true)
                .message(response.getMessage())
                .data(response)
    ...
    /** Registers a new customer; a confirmation OTP is emailed automatically when OTP is enabled. */
    @PostMapping("/signup")
    ...
    public ResponseEntity<ApiResponse<SignupResponse>> signup(@Valid @RequestBody SignupRequest request) {
        ...
        String message = response.isEmailVerified()
                ...
                : "Registration successful. Check your email for the OTP, verify your account, then log in.";
